...
setwd("C:/Users/amw03/Desktop/Research/extremes")
```
...
plot(survfit(Surv(P.snee_extremes$day,P.snee_extremes$status)~P.snee_extremes$primary+P.snee_extremes$secondary_dose),col=c("#a6dba0", "#1b7837", "#af8dc3", "#762a83"),lty=c(1, 1, 1, 1, 3, 3, 3, 3),lwd=4,cex=1,yaxt='n',xaxt='n',cex.main=2,cex.axis=2, ylab="proportion alive", xlab="days post-secondary infection", cex.lab=1.5, xlim=c(0,3))
axis(2,las=2,cex.axis=1,lwd=4)
axis(1,lwd=4, cex.axis=1)
box(lwd=4)
