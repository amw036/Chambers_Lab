...
plot(survfit(Surv(enough_E.fae_P.rett$day, enough_E.fae_P.rett$status) ~ enough_E.fae_P.rett$primary + enough_E.fae_P.rett$X2_dose), col=c("#B5E8FC", "#09B6FC", "#006bb3", "black"),lty=c(1, 1, 1, 1, 3, 3, 3, 3),lwd=4,cex=1,yaxt='n',xaxt='n',cex.main=2,cex.axis=2, ylab="proportion alive", xlab="days post-secondary infection", cex.lab=1.5)
axis(2,las=2,cex.axis=1,lwd=4)
axis(1,lwd=4, cex.axis=1)
box(lwd=4)
legend("topright", bty="n" , c("E.fae-P.rett 0.001", "E.fae-P.rett 0.01", "E.fae-P.rett 0.1", "E.fae-P.rett 1.0", "PBS-P.rett 0.001", "PBS-P.rett 0.01", "PBS-P.rett 0.1", 'PBS-P.rett 1.0'),col=c("#B5E8FC", "#09B6FC", "#006bb3", "black"),lty=c(1, 1, 1, 1, 3, 3, 3, 3),lwd=5, cex=1)
#dev.off()
...
axis(1,lwd=4, cex.axis=1)
box(lwd=4)
legend("topright",inset=0.02, bty="n" , c("PBS-P.rett 0.001", "PBS-P.rett 0.01", "PBS-P.rett 0.1", "PBS-P.rett 1.0", "PBS-P.rett 2.0", "S.m-P.rett 0.001", "S.m-P.rett 0.01", "S.m-P.rett 0.1", "S.m-P.rett 1.0", "S.m-P.rett 2.0"),col=c("#B5E8FC", "#75D6FD", "#09B6FC", "#006bb3", "black"),lty=c(3, 3, 3, 3, 3, 1, 1, 1, 1, 1),lwd=5, cex=1) #a plot for fun
#dev.off()
