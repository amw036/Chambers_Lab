...
axis(1,lwd=4, cex.axis=1)
box(lwd=4)
legend("topright", bty="n" , c("E.fae-P.rett 0.001", "E.fae-P.rett 0.01", "E.fae-P.rett 0.1", "E.fae-P.rett 1.0", "PBS-P.rett 0.001", "PBS-P.rett 0.01", "PBS-P.rett 0.1", 'PBS-P.rett 1.0'),col=c("#B5E8FC", "#09B6FC", "#006bb3", "black"),lty=c(3, 3, 3, 3, 1, 1, 1, 1),lwd=5, cex=1) #a plot for fun
#dev.off()
```
