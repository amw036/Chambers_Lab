...
table(all_S.m_P.rett$primary, all_S.m_P.rett$X2_dose)
png(file="all_S.m_P.rett.png",width=1200,height=900,res=130)
par(mar=c(4,5,1,1)) #sets the margins around the graph so there is room for the labels
plot(survfit(Surv(all_S.m_P.rett$day, all_S.m_P.rett$status) ~ all_S.m_P.rett$primary + all_S.m_P.rett$X2_dose), 
     col=c("gray", "#B5E8FC", "#75D6FD", "#09B6FC", "#055df5", "#003694", "#0600a8", "black"), #colors of lines
     lty=c(1, 1, 1, 1, 1, 1, 1, 1, 3, 3, 3, 3, 3, 3, 3, 3), #type of line, 1 = solid, 3 = dashed
     lwd=5, #line width
     yaxt='n', 
     xaxt='n', 
...
#png(file="all_S.m_P.rett_legend.png",width=1200,height=900,res=130)
#plot(0,0, type='n', bty = 'n', xaxt = 'n', yaxt = 'n')
#legend("topright",inset=0, bty="n" , c("PBS-PBS", "PBS-P.rett 0.001", "PBS-P.rett 0.01", "PBS-P.rett 0.1", "PBS-P.rett 1.0", "PBS-P.rett 2.0", "PBS-P.rett 3.0", "PBS-P.rett 5.0", "S.m-PBS", "S.m-P.rett 0.001", "S.m-P.rett 0.01", "S.m-P.rett 0.1", "S.m-P.rett 1.0", "S.m-P.rett 2.0", "S.m-P.rett 3.0", "S.m-P.rett 5.0"),col=c("gray", "#B5E8FC", "#75D6FD", "#09B6FC", "#055df5", "#003694", "#0600a8", "black"),lty=c(1, 1, 1, 1, 1, 1, 1, 1, 3, 3, 3, 3, 3, 3, 3, 3),lwd=5, cex=1)
#dev.off()
```
