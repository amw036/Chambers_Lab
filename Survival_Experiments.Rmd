...
plot(survfit(Surv(enough_S.m_P.rett$day, enough_S.m_P.rett$status) ~ enough_S.m_P.rett$primary + enough_S.m_P.rett$X2_dose), 
     col=c("#B5E8FC", "#75D6FD", "#09B6FC", "#055df5", "#003694", "#0600a8", "black"), #colors of lines
     lty=c(1, 1, 1, 1, 1, 1, 3, 3, 3, 3, 3, 3, 3), #type of line, 1 = solid, 3 = dashed
     lwd=5, #line width
     yaxt='n', 
     xaxt='n', 
     ylab="proportion alive", #label for the y-axis
...
plot(0,0, type='n', bty = 'n', xaxt = 'n', yaxt = 'n')
legend("topright",inset=0, bty="n" , c("PBS-P.rett 0.001", "PBS-P.rett 0.01", "PBS-P.rett 0.1", "PBS-P.rett 1.0", "PBS-P.rett 2.0", "PBS-P.rett 3.0", "PBS-P.rett 5.0", "S.m-P.rett 0.001", "S.m-P.rett 0.01", "S.m-P.rett 0.1", "S.m-P.rett 1.0", "S.m-P.rett 2.0", "S.m-P.rett 3.0", "S.m-P.rett 5.0"),col=c("#B5E8FC", "#75D6FD", "#09B6FC", "#055df5", "#003694", "#0600a8", "black"),lty=c(1, 1, 1, 1, 1, 1, 1, 3, 3, 3, 3, 3, 3, 3),lwd=5, cex=1)
#dev.off()
```
