...
summary(E.fae_resistance_anova)
```
...
### S.marcescens - P.rettgeri Extremes
...
droplevels(P.snee_varied_primary)
#table(P.snee_varied_primary$rep, P.snee_varied_primary$primary_dose)
