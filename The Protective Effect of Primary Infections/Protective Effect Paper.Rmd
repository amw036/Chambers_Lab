...
```
#Chronic infections reduce mortality following unrelated secondary infections in Drosophila melanogaster
...
```
##Figure 1: Chronic infections with E. faeclis or S. marcescens provided protection against mortality following secondary infection with P. rettgeri {.tabset}
(B) Mortality following secondary infection with P. rettgeri in flies chronically infected with S. marcescens versus control flies not given a chronic infection. Flies chronically infected with E. faecalis were more likely to survive various doses of secondary infection with P. rettgeri (p < 0.0001).
