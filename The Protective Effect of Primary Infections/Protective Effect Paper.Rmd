...
P.rett_varied_primary$primary_dose <- factor(P.rett_varied_primary$primary_dose)
...
#STATISTICS
#Generate a Cox proportional Hazards model which assesses the contribution of infectious dose while controlling for replicate
P.rett_varied_primary_coxph <- coxph(Surv(day, status) ~ primary_dose + rep + rep*primary_dose, data = P.rett_varied_primary)
